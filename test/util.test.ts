...
import { compileTemplate, extractParams, formatUTCDateRuby } from '../src/util';
...
describe('util', () => {
  ...
  describe('utcDateFormatRuby', () => {
    it('formats a Date object for DD Ruby style', () => {
      assert.strictEqual(formatUTCDateRuby(new Date(0)), '1970-01-01 00:00:00 +0000');
      assert.strictEqual(formatUTCDateRuby(new Date(1000)), '1970-01-01 00:00:01 +0000');
    });
  });
});
